...
function showmagicians4(magicians4:string[]):void{
...
let magicians4:string[]=["asim","anas","ghulam"];

let great_magicians5 :string[]=make_great2([...magicians4]);//creating a copy using operator
